...
<head>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="aset/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>I</b>GR</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PPDB</b>IGASAR</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="form_codingan">
          
          <li class="halaman">
          <a href ="index.php">HOME</a></li>
          <li class="halaman">
          <a href ="registrasi.php">tambah user</a></li>
          <li class="data_user"><a href ="data_user.php">user</a></li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="aset/dist/img/avatar2.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Rahmadina</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="aset/dist/img/avatar2.png" class="img-circle" alt="User Image">

                <p>
                  Rahmadina - Web Developer
